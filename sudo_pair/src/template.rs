...
impl Spec {
    ...
    pub(crate) fn expand(&self, template: &[u8]) -> Vec<u8> {
        ...
        while iter.len() != 0 {
            ...
            result.extend(iter.by_ref().take_while(|b| *b != self.escape));
...
mod tests {
    ...
    fn no_expansions() {
        ...
        assert_eq!(template[..], spec.expand(template)[..]);
    }
    ...
    fn expansions() {
        ...
        assert_eq!(b"a: foo, b: bar"[..], spec.expand(template)[..],);
    }
    ...
    fn repeated_expansions() {
        ...
        assert_eq!(b"xxxyxxy"[..], spec.expand(template)[..],);
    }
    ...
    fn expansion_inserts_itself() {
        ...
        assert_eq!(b"test x test"[..], spec.expand(template)[..],);
    }
    ...
    fn expansion_isnt_recursive() {
        ...
        assert_eq!(b"test %x %y %z % %% test"[..], spec.expand(template)[..],);
    }
    ...
    fn expansion_inserts_nothing() {
        ...
        assert_eq!(b"test  test"[..], spec.expand(template)[..],);
    }
    ...
    fn literals() {
        ...
        assert_eq!(b"a: a, b: bar"[..], spec.expand(template)[..],);
    }
    ...
    fn literal_escape_character() {
        ...
        assert_eq!(b"%%%%%%%"[..], spec.expand(template)[..],);
    }
    ...
    fn bug_wontfix_expand_escape_character() {
        ...
        assert_eq!(b"|x|"[..], spec.expand(template)[..]);
    }
    ...
    fn bug_wontfix_swallow_trailing_escape_character() {
        ...
        assert_eq!(b"some text"[..], spec.expand(template)[..]);
    }
}

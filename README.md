...
Contributions are welcome! However, contributors must sign Square's
[contributor license agreement](cla) first. This project should
hopefully be small (~500loc for the plugin itself, ~1kloc for the
wrappers around writing plugins) and well-documented enough for others
...
[sudo_plugin_man]: https://linux.die.net/man/8/sudo_plugin
